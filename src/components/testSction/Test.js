...
export default function TestSction  () {
        ...
        <section>
            <div className="max-w-screen-xl mx-auto px-4 py-28 gap-12 text-gray-600 md:px-8 xl:flex">
                <div className="space-y-5 max-w-2xl mx-auto text-center xl:text-left">
                    ...
                    Explore in-demand courses and develop cutting-edge skills with the British Academy of Sports Science and Technology.
                    </h1>
                    <p className="max-w-xl mx-auto text-black xl:mx-0">
                    The British Academy of Sports Science and Technology offers a wide range of exceptional and practical educational courses in various areas of training. These courses consist of pre-recorded lectures presented by distinguished experts and lecturers in different sports fields.
