...
import "./ConferencePage.css";  // Updated CSS for styling
  ...
  return (
    <div className="conference-page">
      ...
      <p className="page-description">
        Discover the latest conferences happening in your field. Get access to insightful sessions, workshops, and networking opportunities.
      </p>
